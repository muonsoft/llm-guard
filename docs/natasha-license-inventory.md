...
|---|---|---|---|---|
| `github.com/muonsoft/go-razdel` | `1cda9075f3121e9d4db0ac88e7d258f725cf81ee` (`v0.1.0`) | MIT; code port references MIT Razdel revision `668dbe191a5cfd94bebf9155e2ffa5f94ff3fe33` | no external dictionary; pure Go; byte offsets | permitted external production module in M4; retain license notice through normal module distribution |
